...
def test_get_drink_by_profession():
    ...
    assert get_drink_by_profession("scHOOl counselor") == "Anything with Alcohol", "'School Counselor' should map to 'Anything with alcohol'"
    assert get_drink_by_profession("prOgramMer") == "Hipster Craft Beer", "'Programmer' should map to 'Hipster Craft Beer'"
