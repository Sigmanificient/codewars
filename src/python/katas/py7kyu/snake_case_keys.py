...
def test_snake_case():
    ...
    ) == {'first_name': 'Geraldine', 'last_name': 'Smores', 'date_of_birth': '23/5/2040'}
    assert snake_casify(
    ...
    ) == {'first_name': 'Geraldine', 'last_name': 'Simmons', 'date_of_birth': '18/7/2007'}
    assert snake_casify(
    ...
    ) == {'first_name': 'Timothy', 'last_name': 'Pulapakura', 'date_of_birth': '20/7/2011'}
    assert snake_casify(
        {'firstName': 'Remming', 'lastName': 'Bendedict', 'dateOfBirth': '15/10/2030'}
    ) == {'first_name': 'Remming', 'last_name': 'Bendedict', 'date_of_birth': '15/10/2030'}
    assert snake_casify(
    ...
    ) == {'first_name': 'Derek', 'last_name': 'Robertson', 'date_of_birth': '22/11/1987'}
    assert snake_casify(
    ...
    assert snake_casify(
        {'purchaserName': 'Geraldine', 'purchaseProduct': 'Phone', 'dateOfTransaction': '28/12/2003'}
    ) == {'purchaser_name': 'Geraldine', 'purchase_product': 'Phone', 'date_of_transaction': '28/12/2003'}
    assert snake_casify(
        {'purchaserName': 'Geraldine', 'purchaseProduct': 'Guitar', 'dateOfTransaction': '11/3/2017'}
    ) == {'purchaser_name': 'Geraldine', 'purchase_product': 'Guitar', 'date_of_transaction': '11/3/2017'}
    assert snake_casify(
        {'purchaserName': 'Tony', 'purchaseProduct': 'Desktop', 'dateOfTransaction': '3/4/2042'}
    ) == {'purchaser_name': 'Tony', 'purchase_product': 'Desktop', 'date_of_transaction': '3/4/2042'}
