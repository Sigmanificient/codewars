...
def test_sort_by_length():
    ...
    assert sort_by_length(["", "moderately", "brains", "pizza"]) == ["", "pizza", "brains", "moderately"]
    assert sort_by_length(["longer", "longest", "short"]) == ["short", "longer", "longest"]
    assert sort_by_length(["dog", "food", "a", "of"]) == ["a", "of", "dog", "food"]
    assert sort_by_length(["", "dictionary", "eloquent", "bees"]) == ["", "bees", "eloquent", "dictionary"]
