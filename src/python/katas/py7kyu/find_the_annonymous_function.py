...
def find_function(
        func: List[Union[int, Callable[[int], bool]]],
        arr: List[int]
):
...
def test_find_function():
    ...
    assert find_function([9, 3, lambda a: a % 13 != 0, 1, 0], [1, 2, 3, 4]) == [1, 2, 3, 4]
    assert find_function([5, 1, lambda a: a != 0, 1, 0], [0, 1, 2, 3, 4]) == [1, 2, 3, 4]
